# Generated by Django 3.2.25 on 2024-12-14 04:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email_schedule_frequency', models.CharField(choices=[('daily', 'Daily'), ('weekly', 'Weekly'), ('monthly', 'Monthly'), ('yearly', 'Yearly')], default='monthly', max_length=10)),
                ('email_schedule_start_date', models.DateTimeField(default=django.utils.timezone.now)),
        ...
        migrations.CreateModel(
            name='Debt',
            fields=[
                ('id_debt', models.AutoField(primary_key=True, serialize=False)),
                ('amount', models.FloatField()),
                ('description', models.CharField(blank=True, max_length=128, null=True)),
                ('lender', models.CharField(blank=True, max_length=35, null=True)),
                ...
                ('id_user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='logic.user')),
                ('transaction', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='logic.transaction')),
            ],
            options={
                'db_table': 'debts',
            },
